...
class Page {
    constructor(){
        this.sName = "Mimi Pham";
        this.sUrlToEmailer = "https://ctrlaltdlt.herokuapp.com/send/"; 
...
class Contact extends Page{
    render() {
        ...
        <form action="${this.sUrlToEmailer}" method="POST">
            ...
            <div class="form-group">
                <label>Message:<textarea name="message" placeholder="Your Message" class="form-control"
